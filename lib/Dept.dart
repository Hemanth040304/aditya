                ...
                child:Card(
                  ...
                  child: SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [Icon(Icons.electric_bolt,color: Colors.cyanAccent,),
                          const SizedBox(
                            height: 10,
                          ), //SizedBox
                          Text(
                  ...
                  children:[ GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(30.0),
                        child: Column(
                          children: [Icon(Icons.engineering,color: Colors.orange,),
                            const SizedBox(
                              height: 10,
                            ), //SizedBox
                            Text(
                  ...
                  children:[GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(30.0),
                        child: Column(
                          children: [Icon(Icons.computer_sharp,color: Colors.pink,),
                            const SizedBox(
                              height: 10,
                            ), //SizedBox
                            Text(
                  ...
                  children: [GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(30.0),
                        child: Column(
                          children: [Icon(Icons.electrical_services,color: Colors.purpleAccent,),
                            const SizedBox(
                              height: 10,
                            ), //SizedBox
                            Text(
                  ...
                  children:[ GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Icon(Icons.electrical_services,color: Colors.purpleAccent,),
                            const SizedBox(
                              height: 10,
                            ), //SizedBox
                            Text(
